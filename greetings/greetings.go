...
/*
Notes:
1. A function whose name starts with a capital letter
...
func Hello(name string) (string, error) {
	// If no name was given, return an error with a messages
	if name == "" {
...
// randomFormat returns one of a set of greetings messages. The returned message
